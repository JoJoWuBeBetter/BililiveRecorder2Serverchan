...
from models import account_snapshot, settlement, trade_calendar  # noqa: F401 - ensure table metadata is registered
...
app.include_router(trade_calendar_api.router)
